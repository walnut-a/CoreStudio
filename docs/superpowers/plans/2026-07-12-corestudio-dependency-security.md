...
- 直接依赖安全版本固定为：`nanoid 3.3.8`、`sass 1.85.1`；Sass 对应解析的 `immutable` 必须不低于 `5.0.3`。
...
- [ ] **Step 4: 运行 workflow 与安全 contract**
...
```bash
git add docs/doc/corestudio-dependency-security.md docs/doc/README.md docs/superpowers/plans/2026-07-12-corestudio-dependency-security.md
