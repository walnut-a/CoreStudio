...
新项目或空项目没有元素时，工作区应有一个默认范围。建议默认范围以视口中心为基准，大小按“1% 缩放下一个普通窗口能看到的大范围”估算。

推荐默认值：

- `DEFAULT_WORKSPACE_WIDTH = 12000`
- `DEFAULT_WORKSPACE_HEIGHT = 8000`
- 默认中心放在当前视口中心附近。

这个范围足够大，能容纳很多设计图片，但不会让空项目一开始就像无限宇宙一样没有边界感。
