...
export const copy = {
  ...
  generateDialog: {
    ...
    promptLibrary: "常用 Prompt",
    promptLibrarySearch: "搜索常用 Prompt",
    promptLibrarySaveCurrent: "保存当前提示词",
    promptLibraryEmpty: "还没有保存的 Prompt。",
    promptLibraryNoResults: "没有匹配的 Prompt。",
    promptLibraryReplace: "替换",
    promptLibraryAppend: "追加",
