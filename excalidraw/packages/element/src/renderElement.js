...
exports.renderElement = exports.renderSelectionElement = exports.elementWithCanvasCache = exports.DEFAULT_LINK_SIZE = exports.getRenderOpacity = void 0;
exports.getFreedrawOutlineAsSegments = getFreedrawOutlineAsSegments;
const rough_1 = __importDefault(require("roughjs/bin/rough"));
const math_1 = require("@excalidraw/math");
const common_1 = require("@excalidraw/common");
const bounds_1 = require("./bounds");
const cropElement_1 = require("./cropElement");
...
const isPendingImageElement = (element, renderConfig) => (0, typeChecks_1.isInitializedImageElement)(element) &&
...
const getRenderOpacity = (element, containingFrame, elementsPendingErasure, pendingNodes, globalAlpha = 1) => {
    ...
    if (elementsPendingErasure.has(element.id) ||
        ...
        opacity *= common_1.ELEMENT_READY_TO_ERASE_OPACITY / 100;
    }
    return opacity;
};
exports.getRenderOpacity = getRenderOpacity;
const cappedElementCanvasSize = (element, elementsMap, zoom) => {
    ...
    const elementWidth = (0, typeChecks_1.isLinearElement)(element) || (0, typeChecks_1.isFreeDrawElement)(element)
        ? (0, common_1.distance)(x1, x2)
        : element.width;
    const elementHeight = (0, typeChecks_1.isLinearElement)(element) || (0, typeChecks_1.isFreeDrawElement)(element)
        ? (0, common_1.distance)(y1, y2)
        : element.height;
...
const generateElementCanvas = (element, elementsMap, zoom, renderConfig, appState) => {
    ...
    if ((0, typeChecks_1.isLinearElement)(element) || (0, typeChecks_1.isFreeDrawElement)(element)) {
        const [x1, y1] = (0, bounds_1.getElementAbsoluteCoords)(element, elementsMap);
        canvasOffsetX =
            element.x > x1
                ? (0, common_1.distance)(element.x, x1) * window.devicePixelRatio * scale
                : 0;
        canvasOffsetY =
            element.y > y1
                ? (0, common_1.distance)(element.y, y1) * window.devicePixelRatio * scale
                : 0;
    ...
    const rc = rough_1.default.canvas(canvas);
    drawElementOnCanvas(element, rc, context, renderConfig);
    context.restore();
    const boundTextElement = (0, textElement_1.getBoundTextElement)(element, elementsMap);
    const boundTextCanvas = document.createElement("canvas");
    const boundTextCanvasContext = boundTextCanvas.getContext("2d");
    if ((0, typeChecks_1.isArrowElement)(element) && boundTextElement) {
        const [x1, y1, x2, y2] = (0, bounds_1.getElementAbsoluteCoords)(element, elementsMap);
        // Take max dimensions of arrow canvas so that when canvas is rotated
        // the arrow doesn't get clipped
        const maxDim = Math.max((0, common_1.distance)(x1, x2), (0, common_1.distance)(y1, y2));
        ...
        const [, , , , boundTextCx, boundTextCy] = (0, bounds_1.getElementAbsoluteCoords)(boundTextElement, elementsMap);
        boundTextCanvasContext.rotate(-element.angle);
        ...
        boundTextCanvasContext.clearRect(-(boundTextElement.width / 2 + common_1.BOUND_TEXT_PADDING) *
            window.devicePixelRatio *
            scale, -(boundTextElement.height / 2 + common_1.BOUND_TEXT_PADDING) *
            window.devicePixelRatio *
            scale, (boundTextElement.width + common_1.BOUND_TEXT_PADDING * 2) *
            window.devicePixelRatio *
            scale, (boundTextElement.height + common_1.BOUND_TEXT_PADDING * 2) *
            window.devicePixelRatio *
            scale);
    }
    return {
        ...
        canvasOffsetX,
        canvasOffsetY,
        boundTextElementVersion: (0, textElement_1.getBoundTextElement)(element, elementsMap)?.version || null,
        containingFrameOpacity: (0, frame_1.getContainingFrame)(element, elementsMap)?.opacity || 100,
        boundTextCanvas,
        angle: element.angle,
        imageCrop: (0, typeChecks_1.isImageElement)(element) ? element.crop : null,
    };
};
exports.DEFAULT_LINK_SIZE = 14;
const IMAGE_PLACEHOLDER_IMG = typeof document !== "undefined"
    ? document.createElement("img")
    : { src: "" }; // mock image element outside of browser
IMAGE_PLACEHOLDER_IMG.src = `data:${common_1.MIME_TYPES.svg},${encodeURIComponent(`<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="image" class="svg-inline--fa fa-image fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#888" d="M464 448H48c-26.51 0-48-21.49-48-48V112c0-26.51 21.49-48 48-48h416c26.51 0 48 21.49 48 48v288c0 26.51-21.49 48-48 48zM112 120c-30.928 0-56 25.072-56 56s25.072 56 56 56 56-25.072 56-56-25.072-56-56-56zM64 384h384V272l-87.515-87.515c-4.686-4.686-12.284-4.686-16.971 0L208 320l-55.515-55.515c-4.686-4.686-12.284-4.686-16.971 0L64 336v48z"></path></svg>`)}`;
const IMAGE_ERROR_PLACEHOLDER_IMG = typeof document !== "undefined"
    ? document.createElement("img")
    : { src: "" }; // mock image element outside of browser
IMAGE_ERROR_PLACEHOLDER_IMG.src = `data:${common_1.MIME_TYPES.svg},${encodeURIComponent(`<svg viewBox="0 0 668 668" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2"><path d="M464 448H48c-26.51 0-48-21.49-48-48V112c0-26.51 21.49-48 48-48h416c26.51 0 48 21.49 48 48v288c0 26.51-21.49 48-48 48ZM112 120c-30.928 0-56 25.072-56 56s25.072 56 56 56 56-25.072 56-56-25.072-56-56-56ZM64 384h384V272l-87.515-87.515c-4.686-4.686-12.284-4.686-16.971 0L208 320l-55.515-55.515c-4.686-4.686-12.284-4.686-16.971 0L64 336v48Z" style="fill:#888;fill-rule:nonzero" transform="matrix(.81709 0 0 .81709 124.825 145.825)"/><path d="M256 8C119.034 8 8 119.033 8 256c0 136.967 111.034 248 248 248s248-111.034 248-248S392.967 8 256 8Zm130.108 117.892c65.448 65.448 70 165.481 20.677 235.637L150.47 105.216c70.204-49.356 170.226-44.735 235.638 20.676ZM125.892 386.108c-65.448-65.448-70-165.481-20.677-235.637L361.53 406.784c-70.203 49.356-170.226 44.736-235.638-20.676Z" style="fill:#888;fill-rule:nonzero" transform="matrix(.30366 0 0 .30366 506.822 60.065)"/></svg>`)}`;
const drawImagePlaceholder = (element, context, theme) => {
    context.fillStyle = theme === common_1.THEME.DARK ? "#2E2E2E" : "#E7E7E7";
...
const drawElementOnCanvas = (element, rc, context, renderConfig) => {
    switch (element.type) {
        ...
        case "ellipse": {
            ...
            rc.draw(shape_1.ShapeCache.generateElementShape(element, renderConfig));
            break;
        }
        case "arrow":
        case "line": {
            context.lineJoin = "round";
            context.lineCap = "round";
            shape_1.ShapeCache.generateElementShape(element, renderConfig).forEach((shape) => {
                rc.draw(shape);
            });
            break;
        }
        case "freedraw": {
            ...
            context.save();
            const shapes = shape_1.ShapeCache.generateElementShape(element, renderConfig);
            for (const shape of shapes) {
                if (typeof shape === "string") {
                    context.fillStyle =
                        renderConfig.theme === common_1.THEME.DARK
        ...
        case "image": {
            context.save();
            const cacheEntry = element.fileId !== null
                ? renderConfig.imageCache.get(element.fileId)
                : null;
            const img = (0, typeChecks_1.isInitializedImageElement)(element)
                ? cacheEntry?.image
                : undefined;
            if (img != null && !(img instanceof Promise)) {
                if (element.roundness && context.roundRect) {
                    context.beginPath();
                    context.roundRect(0, 0, element.width, element.height, (0, utils_1.getCornerRadius)(Math.min(element.width, element.height), element));
                    context.clip();
                }
                ...
                const shouldInvertImage = renderConfig.theme === common_1.THEME.DARK &&
                    cacheEntry?.mimeType === common_1.MIME_TYPES.svg;
                if (shouldInvertImage && common_1.isSafari) {
                    ...
                    if (shouldInvertImage) {
                        context.filter = common_1.DARK_THEME_FILTER;
                    }
        ...
        default: {
            if ((0, typeChecks_1.isTextElement)(element)) {
                const rtl = (0, common_1.isRTL)(element.text);
                ...
                context.save();
                context.font = (0, common_1.getFontString)(element);
                context.fillStyle =
                    renderConfig.theme === common_1.THEME.DARK
                        ? (0, common_1.applyDarkModeFilter)(element.strokeColor)
                        : element.strokeColor;
                ...
                const horizontalOffset = element.textAlign === "center"
                    ...
                    : element.textAlign === "right"
                        ? element.width
                        : 0;
                const lineHeightPx = (0, textMeasurements_1.getLineHeightInPx)(element.fontSize, element.lineHeight);
...
exports.elementWithCanvasCache = new WeakMap();
const generateElementWithCanvas = (element, elementsMap, renderConfig, appState) => {
    const zoom = renderConfig
        ? appState.zoom
        : {
            value: 1,
        };
    const prevElementWithCanvas = exports.elementWithCanvasCache.get(element);
    const shouldRegenerateBecauseZoom = prevElementWithCanvas &&
        prevElementWithCanvas.zoomValue !== zoom.value &&
        !appState?.shouldCacheIgnoreZoom;
    const boundTextElement = (0, textElement_1.getBoundTextElement)(element, elementsMap);
    const boundTextElementVersion = boundTextElement?.version || null;
    const imageCrop = (0, typeChecks_1.isImageElement)(element) ? element.crop : null;
    const containingFrameOpacity = (0, frame_1.getContainingFrame)(element, elementsMap)?.opacity || 100;
    if (!prevElementWithCanvas ||
        ...
        exports.elementWithCanvasCache.set(element, elementWithCanvas);
...
const drawElementFromCanvas = (elementWithCanvas, context, renderConfig, appState, allElementsMap) => {
    ...
    const [x1, y1, x2, y2] = (0, bounds_1.getElementAbsoluteCoords)(element, allElementsMap);
    const cx = ((x1 + x2) / 2 + appState.scrollX) * window.devicePixelRatio;
    const cy = ((y1 + y2) / 2 + appState.scrollY) * window.devicePixelRatio;
    context.save();
    context.scale(1 / window.devicePixelRatio, 1 / window.devicePixelRatio);
    const boundTextElement = (0, textElement_1.getBoundTextElement)(element, allElementsMap);
    if ((0, typeChecks_1.isArrowElement)(element) && boundTextElement) {
        ...
        if (import.meta.env.VITE_APP_DEBUG_ENABLE_TEXT_CONTAINER_BOUNDING_BOX ===
            ...
            const textElement = (0, textElement_1.getBoundTextElement)(element, allElementsMap);
            const coords = (0, textElement_1.getContainerCoords)(element);
            context.strokeStyle = "#c92a2a";
            context.lineWidth = 3;
            context.strokeRect((coords.x + appState.scrollX) * window.devicePixelRatio, (coords.y + appState.scrollY) * window.devicePixelRatio, (0, textElement_1.getBoundTextMaxWidth)(element, textElement) * window.devicePixelRatio, (0, textElement_1.getBoundTextMaxHeight)(element, textElement) * window.devicePixelRatio);
        }
    }
    context.restore();
...
exports.renderSelectionElement = renderSelectionElement;
const renderElement = (element, elementsMap, allElementsMap, rc, context, renderConfig, appState) => {
    ...
    context.globalAlpha = (0, exports.getRenderOpacity)(element, (0, frame_1.getContainingFrame)(element, elementsMap), renderConfig.elementsPendingErasure, renderConfig.pendingFlowchartNodes, reduceAlphaForSelection ? common_1.DEFAULT_REDUCED_GLOBAL_ALPHA : 1);
    switch (element.type) {
        case "magicframe":
        case "frame": {
            if (appState.frameRendering.enabled && appState.frameRendering.outline) {
                ...
                if ((0, typeChecks_1.isMagicFrameElement)(element)) {
                    context.strokeStyle =
                        appState.theme === common_1.THEME.LIGHT
                            ? "#7affd7"
                            : (0, common_1.applyDarkModeFilter)("#1d8264");
                }
            ...
            if (renderConfig.isExporting) {
                ...
                if ((0, typeChecks_1.isTextElement)(element)) {
                    ...
                    if ((0, typeChecks_1.isArrowElement)(container)) {
                        const boundTextCoords = linearElementEditor_1.LinearElementEditor.getBoundTextElementPosition(container, element, elementsMap);
                ...
                if ((0, typeChecks_1.isArrowElement)(element) && boundTextElement) {
                    ...
                    const tempRc = rough_1.default.canvas(tempCanvas);
                ...
                !appState?.shouldCacheIgnoreZoom &&
                    ...
                    (!element.angle ||
                        ...
                        (0, math_1.isRightAngleRads)(element.angle))) {
                ...
                if (element.id === appState.croppingElementId &&
                    (0, typeChecks_1.isImageElement)(elementWithCanvas.element) &&
                    elementWithCanvas.element.crop !== null) {
                    context.save();
                    context.globalAlpha = 0.1;
                    const uncroppedElementCanvas = generateElementCanvas((0, cropElement_1.getUncroppedImageElement)(elementWithCanvas.element, elementsMap), allElementsMap, appState.zoom, renderConfig, appState);
...
function getFreedrawOutlineAsSegments(element, points, elementsMap) {
    const bounds = (0, bounds_1.getElementBounds)({
        ...element,
        angle: 0,
    }, elementsMap);
    const center = (0, math_1.pointFrom)((bounds[0] + bounds[2]) / 2, (bounds[1] + bounds[3]) / 2);
    (0, common_1.invariant)(points.length >= 2, "Freepath outline must have at least 2 points");
    return points.slice(2).reduce((acc, curr) => {
        acc.push((0, math_1.lineSegment)(acc[acc.length - 1][1], (0, math_1.pointRotateRads)((0, math_1.pointFrom)(curr[0] + element.x, curr[1] + element.y), center, element.angle)));
        return acc;
    }, [
        (0, math_1.lineSegment)((0, math_1.pointRotateRads)((0, math_1.pointFrom)(points[0][0] + element.x, points[0][1] + element.y), center, element.angle), (0, math_1.pointRotateRads)((0, math_1.pointFrom)(points[1][0] + element.x, points[1][1] + element.y), center, element.angle)),
    ]);
}
