...
exports.distributeElements = void 0;
const binding_1 = require("./binding");
const bounds_1 = require("./bounds");
const groups_1 = require("./groups");
const distributeElements = (selectedElements, elementsMap, distribution, appState, scene) => {
    const [start, mid, end, extent] = distribution.axis === "x"
        ? ["minX", "midX", "maxX", "width"]
        : ["minY", "midY", "maxY", "height"];
    const bounds = (0, bounds_1.getCommonBoundingBox)(selectedElements);
    const groups = (0, groups_1.getSelectedElementsByGroup)(selectedElements, elementsMap, appState)
        .map((group) => [group, (0, bounds_1.getCommonBoundingBox)(group)])
