...
exports.ExcalidrawFontFace = void 0;
const common_1 = require("@excalidraw/common");
const subset_main_1 = require("../subset/subset-main");
class ExcalidrawFontFace {
    urls;
    fontFace;
    static ASSETS_FALLBACK_URL = `https://esm.sh/${import.meta.env.PKG_NAME
    ...
    async getContent(codePoints) {
        ...
        while (i < this.urls.length) {
            ...
            try {
                ...
                const base64 = await (0, subset_main_1.subsetWoff2GlyphsByCodepoints)(arrayBuffer, codePoints);
                return base64;
            }
            catch (e) {
    ...
    static createUrls(uri) {
        ...
        if (uri.startsWith(common_1.LOCAL_FONT_PROTOCOL)) {
...
exports.ExcalidrawFontFace = ExcalidrawFontFace;
