    ...
    format
        ...
        if (tagStartMatch !== null) {
            ...
            if (name === stack[stack.length - 1].name) {
                ...
                const itemChildren = react_1.default.createElement(react_1.default.Fragment, {}, ...item.children);
...
const Trans = ({ i18nKey, children, ...props }) => {
    ...
    return react_1.default.createElement(react_1.default.Fragment, {}, ...getTransChildren(t(i18nKey), props));
};
