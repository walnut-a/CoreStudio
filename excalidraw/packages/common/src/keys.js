...
exports.shouldRotateWithDiscreteAngle = exports.shouldMaintainAspectRatio = exports.shouldResizeFromCenter = exports.isArrowKey = exports.matchKey = exports.isLatinChar = exports.KeyCodeMap = exports.KEYS = exports.CODES = void 0;
const editorInterface_1 = require("./editorInterface");
exports.CODES = {
    EQUAL: "Equal",
    MINUS: "Minus",
    NUM_ADD: "NumpadAdd",
...
exports.KEYS = {
    ...
    BACKSPACE: "Backspace",
    ALT: "Alt",
    CTRL_OR_CMD: editorInterface_1.isDarwin ? "metaKey" : "ctrlKey",
    DELETE: "Delete",
    ENTER: "Enter",
    ESCAPE: "Escape",
    QUESTION_MARK: "?",
...
exports.KeyCodeMap = new Map([
    [exports.KEYS.Z, exports.CODES.Z],
    [exports.KEYS.Y, exports.CODES.Y],
]);
const isLatinChar = (key) => /^[a-z]$/.test(key.toLowerCase());
...
const matchKey = (event, key) => {
    ...
    const code = exports.KeyCodeMap.get(key);
    return Boolean(code && !(0, exports.isLatinChar)(event.key) && event.code === code);
};
exports.matchKey = matchKey;
const isArrowKey = (key) => key === exports.KEYS.ARROW_LEFT ||
    key === exports.KEYS.ARROW_RIGHT ||
    key === exports.KEYS.ARROW_DOWN ||
    key === exports.KEYS.ARROW_UP;
exports.isArrowKey = isArrowKey;
const shouldResizeFromCenter = (event) => event.altKey;
exports.shouldResizeFromCenter = shouldResizeFromCenter;
const shouldMaintainAspectRatio = (event) => event.shiftKey;
exports.shouldMaintainAspectRatio = shouldMaintainAspectRatio;
const shouldRotateWithDiscreteAngle = (event) => event.shiftKey;
exports.shouldRotateWithDiscreteAngle = shouldRotateWithDiscreteAngle;
