...
export const enCopy: DesktopCopy = {
  ...
  generateDialog: {
    ...
    showComposer: "Expand image generation composer",
  ...
  applicationSettings: {
    ...
    imageGenerationPage: {
      ...
      catalogPublishedAt: (date: string) => `Updated ${date}`,
      catalogBuiltin: "Built-in catalog",
    ...
    providerEditor: {
      ...
      capabilityAutoStatus: "Detected automatically from the model ID",
      capabilityManualStatus: "Adjusted manually",
      adjustCapabilities: "Adjust manually",
      restoreAutomaticCapabilities: "Restore automatic detection",
      supportsReferenceImages: "Supports reference images",
      sizeControl: "Size control",
      aspectRatioSize: "Control by aspect ratio",
      exactSize: "Control by width and height",
      supportsSeed: "Supports seed",
      supportsImageCount: "Supports multiple outputs",
      capabilitySummary: {
        referenceImages: "Reference images",
        textOnly: "Text only",
        aspectRatio: "Aspect ratio sizing",
        exactSize: "Width and height sizing",
        seed: "Seed",
    ...
    codexPage: {
      ...
      readyDescription:
        "Local installation files and versions passed. Host login, Skill loading, and browser connectivity have not been checked.",
      actionDescription:
      ...
      environmentChecksDescription:
        "Checks local CLI, Skill files, and version records; it does not establish an Agent task connection.",
      checkStatus: {
        ready: "Ready",
        missing: "Missing",
